...
mimosoid_trait$species <- tips

# Drop flagged tips
mimoseae_species <- filter(mimoseae_species, which(mimoseae_species$species == "drop"))
mimoseae_species <- mimoseae_species |>
